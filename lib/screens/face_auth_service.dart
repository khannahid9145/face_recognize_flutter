...
class FaceAuthRegister extends StatefulWidget {
  const FaceAuthRegister({super.key});

  @override
  State<FaceAuthRegister> createState() => _FaceAuthRegisterState();
}

class _FaceAuthRegisterState extends State<FaceAuthRegister> {
...
Future<void> _initialize() async {
  ...
  Future<void> _captureAndDetect() async {
    if (_cam == null || _busy) {
      print('Camera not ready or busy');
      return;
    }
    ...
    try {
      ...
      print('Picture taken, processing...');
      ...
      if (faces.isNotEmpty) {
        ...
        if (decoded == null) {
          throw Exception('Failed to decode image: ${f.path}');
        }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // 2) Capture button (ALWAYS visible)
          Padding(
